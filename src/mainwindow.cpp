...
void MainWindow::on_open_triggered()
{
    ...
    else
    {
        ...
        {
            QMessageBox::information(this,u8"信息",u8"打开文件失败");
        }
        else
        {
...
{
    QString dir = QFileDialog::getExistingDirectory(this, tr(u8"保存提取结果"),
                                                     "./",
    ...
    {
        QMessageBox mesg;
        mesg.warning(this,u8"警告",u8"保存提取结果失败!");
        return;
    }
    else
    {
...
void MainWindow::on_run_triggered()
{
    ...
    if(ui->label->canRan()){
        ...
        QMessageBox mesg;
        mesg.warning(this,u8"警告",u8"请标记完再运行！");
        return;
    }
}
...
void MainWindow::on_action_4_triggered()
{
    ...
    {
        QMessageBox mesg;
        mesg.warning(this,u8"警告",u8"重置失败!");
        return;
    }
    else
    {
